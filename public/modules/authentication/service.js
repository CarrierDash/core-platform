...
.factory('AuthenticationService', ['communicationService', '$rootScope', 
	...
	service.emailVerification = function(inputJsonString, callback) {
    	communicationService.resultViaPost(webservices.email_verification, appConstants.authorizationKey, headerConstants.json, inputJsonString, function(response) {
      		callback(response.data);
    	}); 
    };
